...
>
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('admin.ebooks.index'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"></span>
                @endif
                <a
                ...
                <span class="ml-4">EBooks</span>
                    </a>
            </li>

            <li class="relative px-6 py-3">
                @if (request()->routeIs('admin.ebooks.create'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"></span>
                @endif
                <a
                ...
                >
                    ...
                    <span class="ml-4">Add EBook</span>
                </a>
            </li>

            <!-- Sidebar: Student Subscriptions -->
            <li class="relative px-6 py-3">
                ...
                >
                    ...
                    <span class="ml-4">Student Subscriptions</span>
                </a>
            </li>
