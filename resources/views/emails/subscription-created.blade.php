    ...
    <div class="max-w-2xl mx-auto my-8 bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="bg-gray-100 p-4 rounded-lg mb-4">
                <p class="mb-2"><strong class="text-gray-800">Website:</strong> <a href="https://ebook.stsinstitute.site/public/student/login" class="text-purple-600 underline">{{ url('https://ebook.stsinstitute.site/public/student/login') }}</a></p>
